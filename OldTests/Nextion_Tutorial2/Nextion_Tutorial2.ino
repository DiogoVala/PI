...
void b0PushCallback(void *ptr)  // Press event for button b0
{
  ...
  Serial1.print("n3.val=");  // This is sent to the nextion display to set what object name (before the dot) and what atribute (after the dot) are you going to change.
  Serial1.print(counter);  // This is the value you want to send to that object and atribute mentioned before.
...
void setup() {  // Put your setup code here, to run once:
  ...
  Serial1.begin(9600);  // Start serial comunication at baud=9600
